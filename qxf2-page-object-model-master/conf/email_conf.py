...
sender = 'lizhihong@buckyos.com' #Add senders email address here
targets = ['lizhihong@buckyos.com'] # Add recipients email address in a list , #,'wangpingni@buckyos.com'
