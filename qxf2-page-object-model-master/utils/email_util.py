...
class Email_Util:
    ...
    def connect(self,imap_host):
        ...
        self.mail = smtplib.SMTP() #imaplib.IMAP4_SSL(imap_host)
        self.mail.connect(imap_host)
        return self.mail
...
if __name__=='__main__':
    ...
    sender = conf_file.sender
    receiver = conf_file.targets
    subject = '雨燕安卓自动化测试报告'
    test_result = {
    ...
    msg = MIMEText("""
                ...
                <table color="CCCC33" width="800" border="1" cellspacing="0" cellpadding="5" text-align="center">
                        ...
                        <tr>   
                                ...
                                <td><image src="%(acclerate_img)s" width="360" height="640"> </td>
                        ...
                        <tr>   
                                ...
                                <td><image src="%(iqiyi_img)s" width="360" height="640"> </td>
                        ...
                        <tr>   
                                ...
                                <td><image src="%(tecentVideo_img)s" width="360" height="640"> </td>
                        </tr>
                        <tr>   
                                ...
                                <td><image src="%(youkuVideo_img)s" width="360" height="640"> </td>
                        </tr>
                        <tr>   
                                ...
                                <td><image src="%(bilibli_img)s" width="360" height="640"> </td>
                        </tr>
                        <tr>   
                                ...
                                <td><image src="%(tudouVideo_img)s" width="360" height="640"> </td>
                        </tr>
                        <tr>   
                                ...
                                <td><image src="%(qqMusic_img)s" width="360" height="640"> </td>
                        </tr>
                        <tr>   
                                ...
                                <td><image src="%(xiamiMusic_img)s" width="360" height="640"> </td>
                        </tr>
                        <tr>   
                                ...
                                <td><image src="%(net163_img)s" width="360" height="640"> </td>
                        </tr>
                        <tr>   
                        <td text-align="center">央视影音cctv5 </td>

                                <td>%(cctv5_result)s </td>

                                <td><image src="%(cctv5_img)s" width="360" height="640"> </td>
                        </tr>
                </table>""" % test_result,"HTML")
    msg['Subject'] = Header(subject,'utf-8')
    msg['from'] = "lizhihong@buckyos.com"  
    msg['to'] = "lizhihong@buckyos.com" 
    print(imap_host,username,password)
    ...
    email_obj.mail.sendmail(sender,receiver,msg.as_string())  
